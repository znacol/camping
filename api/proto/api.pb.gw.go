...
func request_CampingService_Do_0(ctx context.Context, marshaler runtime.Marshaler, client CampingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterCampingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CampingServiceClient) error {
	...
	mux.Handle("POST", pattern_CampingService_Do_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CampingService_Do_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_CampingService_Do_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_CampingService_Do_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "camping", "do"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_CampingService_Do_0 = runtime.ForwardResponseMessage
)
